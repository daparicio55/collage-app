...
<html lang="es" data-bs-theme="auto">
  <head>
    ...
    <link href="{{ asset('recursos/css/dashboard.css') }}" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
  ...
  <body>
          ...
          >
            ...
            >
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ route('dashboard.actividades.index') }}">
                    <svg class="bi" aria-hidden="true">
    ...
    ></script>
    <script src="{{ asset('recursos/js/dashboard.js') }}" class="astro-vvvwv3sm"></script>
  </body>
</html>
